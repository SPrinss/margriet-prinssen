...
allowed-tools: Bash, BashOutput, Read, Edit, MultiEdit, Write, Grep, Glob,
...
## Variables
USER_PROMPT: $1
MODEL: $2 (defaults to 'claude-opus-4-1-20250805' if not provided)
...
Every few tool calls you should update the REPORT_FILE ## Progress section. Follow this file structure.
...
When it completes it will rename the file to '${REPORT_FILE%.md}.complete.md' on success or '${REPORT_FILE%.md}.failed.md' if it fails.
```